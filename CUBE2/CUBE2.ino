...
{0xFC, 0x81, 0x01, 0x01, 0x7E, 0x80, 0x81, 0x7F}, //S
{0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xC3, 0xFF, 0x7E}, //U
{0xFF, 0x10, 0x10, 0x10, 0x10, 0x11, 0x11, 0x0E}, //J
{0x3C, 0x42, 0xC3, 0xC3, 0xFF, 0xC3, 0xC3, 0xC3}, //A
{0x44, 0x44, 0x44, 0x78, 0x40, 0x41, 0x42, 0x7C}, //Y
  
 /* {0x3C, 0x42, 0x42, 0x42, 0x42, 0x42, 0x42, 0x3C}, //0
  {0x10, 0x18, 0x14, 0x10, 0x10, 0x10, 0x10, 0x7C}, //1
...
void loop() {
  ...
  switch (currentEffect) {
    ...
    case PLANE_BOING: planeBoing(); Serial.println("plane"); break;
    case SEND_VOXELS: sendVoxels(); Serial.println("voxel"); break;
    case WOOP_WOOP: woopWoop(); Serial.println("woop"); break;
    case CUBE_JUMP: cubeJump(); Serial.println("jump"); break;
    case GLOW: glow(); Serial.println("glow"); break;
    case TEXT: text("0123456789", 5); Serial.println("text");  break;
    case LIT: lit(); Serial.println("lit"); break;
